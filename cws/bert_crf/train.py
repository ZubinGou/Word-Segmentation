...
def train(train_loader, dev_loader, model, optimizer, scheduler, model_dir,
    ...
    for epoch in range(1, config.epoch_num + 1):
        ...
        logging.info("Epoch: {}, dev loss: {}, f1 score: {:.2f}".format(
            epoch, val_metrics['loss'], val_f1 * 100))
        ...
        if (patience_counter >= config.patience_num
                and epoch > config.min_epoch_num) or epoch == config.epoch_num:
