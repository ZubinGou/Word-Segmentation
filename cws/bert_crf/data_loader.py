...
class SegDataset(Dataset):
    ...
    def __init__(self,
        ...
        self.id2label = {
            _id: _label
            for _label, _id in list(config.label2id.items())
        }
    ...
    def preprocess(self, origin_sentences, origin_labels):
        ...
        sentences = []
        labels = []
        for line in tqdm(origin_sentences, desc="Preprocess"):
    ...
    def collate_fn(self, batch):
        ...
        batch_label_starts = torch.tensor(np.array(batch_label_starts),
                                          dtype=torch.long)
